...
//AppDbContext setup with SQL Server connection string from appsettings.json
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "SecureNoteTakingApi",
        Version = "v1",
        Description = "A secure note-taking API with JWT authentication"
    });
